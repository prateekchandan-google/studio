...
// This is now just initial seed data. Puzzles will be fetched from Firestore.
export const puzzles: Puzzle[] = [
  {
    id: '1',
    title: 'The Echoing Cave',
    puzzle: 'I have a voice but cannot speak. I have a bed but never sleep. What am I?',
  ...
  },
  {
    ...
    puzzle: 'A merchant can place 8 large boxes or 10 small boxes into a carton for shipping. In one shipment, he sent a total of 96 boxes. If there are more large boxes than small boxes, how many cartons did he ship?',
